...
**DECLARATION**: This repo was not vibecoded. No generative language model was used to write any snipet of it. My participation here was merely for formative purposes, making *vibecoding* totally pointless. However, considerable passages of it are adaptations from the follow tutorials:
